% Class/Object of UAV Robot version 3. Works with the simulation file 'solverTB_v3'.
...
classdef UAV_Robot_v3
    ...
    methods
        ...
        %constructor method
        function uav = UAV_Robot_v3(ID, position, Wo, priority, level, saturation)
            if nargin > 3
...
%COMMS
        ...
        function uav = receive(uav, mate)
            global r;                                                       %global UAV objects vector
            %global variables for performance parameters
            ...
            if detected == 1
                ...
                else                                                        %if the conflict is still there, VelMod and Hover couldn't resolve it
